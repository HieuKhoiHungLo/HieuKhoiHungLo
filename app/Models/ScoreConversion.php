...
class ScoreConversion extends Model {
    ...
    public function getConvertedScore($type, $score) {
        // Find rule where min <= score <= max
        // Since we stored max or equal, logic: 
        // e.g. IELTS 4.0-4.0 -> 10. 
        // IELTS 4.5-5.0 -> 10.
        // Logic: SELECT diem_quy_doi FROM table WHERE loai = ? AND diem_min <= ? AND diem_max >= ? ORDER BY diem_quy_doi DESC LIMIT 1
