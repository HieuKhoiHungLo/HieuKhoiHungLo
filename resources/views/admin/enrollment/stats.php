        ...
        <div class="flex items-center gap-2 w-full md:w-auto">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" style="display: none;"
                    ...
                    <a href="<?= url('/admin/enrollment/export-enrolled?session_id=' . $activeSessionId) ?>" class="block w-full text-left px-4 py-3 hover:bg-emerald-50 text-slate-700 text-xs font-semibold border-b border-slate-100 transition-colors flex items-center gap-2">
                    ...
                    <a href="<?= url('/admin/enrollment/export-bank-cards?session_id=' . $activeSessionId) ?>" class="block w-full text-left px-4 py-3 hover:bg-purple-50 text-purple-700 text-xs font-bold transition-colors flex items-center gap-2 bg-purple-50/40 border-b border-slate-100">
