...
<div id="form_personal" class="hidden animate-in fade-in slide-in-from-top-4 duration-300">
    <div class="bg-white rounded-[2rem] p-8 border border-blue-100 shadow-xl shadow-blue-50/50">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="font-black text-slate-800 text-lg uppercase tracking-tight">Thông tin Liên lạc</h3>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Hộ khẩu thường trú -->
            <div class="col-span-1 md:col-span-2">
                <label class="block text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">Hộ khẩu thường trú</label>
                <div class="relative">
            ...
            <div>
                ...
                <div x-data="wardSearch('<?= $user['ma_tinh_thuong_tru'] ?? '' ?>', '<?= $user['ma_xa_thuong_tru'] ?? '' ?>')" 
                    ...
                    <div x-show="open" 
                        ...
                        <div x-show="!isLoading && filteredWards.length === 0" class="p-4 text-center text-slate-400 text-xs italic">
            ...
            <div class="col-span-2">
                <label class="block text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">Địa chỉ chi tiết</label>
                <div class="relative">
                    <i class="fas fa-home absolute left-4 top-1/2 -translate-y-1/2 text-slate-300"></i>
