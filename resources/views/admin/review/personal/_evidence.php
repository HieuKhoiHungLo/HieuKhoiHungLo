    ...
    <div class="w-1/3 mx-auto">
        ...
        <?php else: ?>
            <div class="relative group">
                ...
                <button type="button" onclick="rotateEvidenceImage('<?= $user['anh_dai_dien'] ?>', 'current_avatar', this)" class="absolute top-2 right-2 z-20 w-8 h-8 bg-white/90 hover:bg-[#0066FF] text-slate-700 hover:text-white rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform hover:scale-110" title="Xoay ảnh 90 độ">
    ...
    <div class="mt-2">
        <?php if (!empty($user['anh_cccd_truoc'])): ?>
            <div class="relative group mb-3">
                ...
                <button type="button" onclick="rotateEvidenceImage('<?= $user['anh_cccd_truoc'] ?>', 'current_cccd_front', this)" class="absolute top-2 right-2 z-20 w-8 h-8 bg-white/90 hover:bg-[#0066FF] text-slate-700 hover:text-white rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform hover:scale-110" title="Xoay ảnh 90 độ">
                    <i class="fas fa-redo-alt text-sm"></i>
                </button>
    ...
    <div class="mt-2">
        <?php if (!empty($user['anh_cccd_sau'])): ?>
            <div class="relative group mb-3">
                ...
                <button type="button" onclick="rotateEvidenceImage('<?= $user['anh_cccd_sau'] ?>', 'current_cccd_back', this)" class="absolute top-2 right-2 z-20 w-8 h-8 bg-white/90 hover:bg-[#0066FF] text-slate-700 hover:text-white rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform hover:scale-110" title="Xoay ảnh 90 độ">
                    <i class="fas fa-redo-alt text-sm"></i>
                </button>
