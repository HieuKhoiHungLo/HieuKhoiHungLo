            ...
            <div class="p-4 w-full flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
                            ...
                            <div class="flex flex-col">
                                <div class="flex items-center gap-2 mb-0.5">
                                    <span class="w-5 h-5 rounded-full bg-sky-100 text-sky-500 flex items-center justify-center text-[8px]"><i class="fas fa-map-marker-alt"></i></span>
                                    <span class="text-[11px] font-bold text-sky-400 uppercase tracking-wider">Nơi cấp</span>
                                </div>
                                <span class="font-bold text-slate-800 text-lg"><?= $cert['noi_cap'] ?? '---' ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 border-slate-100 pt-3 sm:pt-0 mt-2 sm:mt-0 px-4 sm:px-0">
                    <div class="text-right flex flex-col items-end">
                        ...
                        <span class="text-2xl font-black text-[#0066FF] tracking-tight"><?= $cert['diem_chung_chi'] ?></span>
                    </div>
                </div>
            </div>
        </div>
