    ...
    <div class="mt-6 bg-slate-50 rounded-[2rem] p-6 border border-slate-200 shadow-sm transition-all hover:bg-white hover:shadow-md">
        <div class="flex items-center justify-between mb-5">
                <h4 class="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center">
                    <i class="fas fa-clipboard-check mr-2"></i> Tình trạng kiểm duyệt Chứng chỉ
                </h4>
        ...
        <div class="<?= $checkRejected ? '' : 'hidden' ?> mt-4 animate-in zoom-in-95 duration-200" id="reason_certs_container">
            <textarea name="note_certs" class="w-full p-4 bg-white border-2 border-rose-100 rounded-2xl text-sm font-bold text-slate-700 placeholder:text-slate-300 focus:border-rose-500 focus:ring-0 outline-none transition-all" rows="3" placeholder="Nhập lý do chi tiết..."></textarea>
        </div>
    </div>
