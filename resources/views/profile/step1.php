                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                            ...
                            <div class="flex flex-col items-center justify-start pt-2">
                                ...
                                <div class="group relative w-40 h-48 sm:h-52 border-2 border-dashed border-gray-300 rounded-xl flex flex-col justify-center items-center bg-gray-50 overflow-hidden transition-all hover:border-hvu-red/50">
                                    <img id="preview_avatar" loading="lazy" src="<?= $user['anh_dai_dien'] ? (strpos($user['anh_dai_dien'], 'http') === 0 ? $user['anh_dai_dien'] : url($user['anh_dai_dien'])) : '' ?>" class="<?= !empty($user['anh_dai_dien']) ? 'block' : 'hidden' ?> w-full h-full object-cover">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="group relative w-full h-40 sm:h-48 border-2 border-dashed border-gray-300 rounded-2xl flex flex-col justify-center items-center bg-gray-50 overflow-hidden transition-all hover:border-hvu-red/50">
                                    <img id="preview_front" loading="lazy" src="<?= $user['anh_cccd_truoc'] ? (strpos($user['anh_cccd_truoc'], 'http') === 0 ? $user['anh_cccd_truoc'] : url($user['anh_cccd_truoc'])) : '' ?>" class="<?= !empty($user['anh_cccd_truoc']) ? 'block' : 'hidden' ?> w-full h-full object-contain transition-transform duration-300 group-hover:scale-[1.15]" ondblclick="if(this.src && !this.src.startsWith('data:')) window.open(this.src, '_blank')" title="Click đúp để xem kích thước thật">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="group relative w-full h-40 sm:h-48 border-2 border-dashed border-gray-300 rounded-2xl flex flex-col justify-center items-center bg-gray-50 overflow-hidden transition-all hover:border-hvu-red/50">
                                    <img id="preview_back" loading="lazy" src="<?= $user['anh_cccd_sau'] ? (strpos($user['anh_cccd_sau'], 'http') === 0 ? $user['anh_cccd_sau'] : url($user['anh_cccd_sau'])) : '' ?>" class="<?= !empty($user['anh_cccd_sau']) ? 'block' : 'hidden' ?> w-full h-full object-contain transition-transform duration-300 group-hover:scale-[1.15]" ondblclick="if(this.src && !this.src.startsWith('data:')) window.open(this.src, '_blank')" title="Click đúp để xem kích thước thật">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10 pt-10 border-t border-gray-100">
                            ...
                            <div id="kv_evidence_section" class="<?= ($user['is_custom_kv'] ?? false) ? '' : 'hidden' ?>">
                                ...
                                <div class="group relative w-full h-48 border-2 border-dashed border-red-200 rounded-2xl flex flex-col justify-center items-center bg-red-50/30 overflow-hidden transition-all hover:border-hvu-red/50">
                                    <img id="preview_kv" loading="lazy" src="<?= !empty($user['file_minh_chung_kv']) ? (strpos($user['file_minh_chung_kv'], 'http') === 0 ? $user['file_minh_chung_kv'] : url($user['file_minh_chung_kv'])) : '' ?>" class="<?= !empty($user['file_minh_chung_kv']) ? 'block' : 'hidden' ?> w-full h-full object-contain transition-transform duration-300 group-hover:scale-[1.15]" ondblclick="if(this.src && !this.src.startsWith('data:')) window.open(this.src, '_blank')" title="Click đúp để xem kích thước thật">
