                        ...
                        <?php if (!empty($certs)): ?>
                            <?php foreach ($certs as $index => $cert): ?>
                                <div class="cert-item bg-gray-50/50 border border-gray-100 rounded-2xl p-6 relative group/item">
                                    <button type="button" onclick="removeCert(this)" class="absolute top-4 right-4 text-gray-400 hover:text-red-500 transition-colors">
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <label class="flex-grow cursor-pointer group/upload">
                                                    <div class="h-16 border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-white group-hover/upload:bg-red-50 group-hover/upload:border-hvu-red transition-all">
                                                        <i class="fas fa-cloud-upload-alt mr-2 text-gray-400 group-hover/upload:text-hvu-red"></i>
                                                        <span class="text-xs font-bold text-gray-400 group-hover/upload:text-hvu-red">Chọn ảnh mới nếu muốn thay đổi</span>
                                                ...
                                                <?php if (!empty($cert['file_minh_chung_cc'])): ?>
                                                    <div class="w-16 h-16 rounded-xl border border-gray-200 overflow-hidden shadow-sm flex-shrink-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <label class="block cursor-pointer group/upload">
                    <div class="h-16 border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-white group-hover/upload:bg-red-50 group-hover/upload:border-hvu-red transition-all">
                        <i class="fas fa-cloud-upload-alt mr-2 text-gray-400 group-hover/upload:text-hvu-red"></i>
                        <span class="text-xs font-bold text-gray-400 group-hover/upload:text-hvu-red file-label">Chọn ảnh minh chứng</span>
