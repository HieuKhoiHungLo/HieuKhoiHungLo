    ...
    <div style="padding:12px;">
        ...
        <div id="hvu-tab-1" class="hvu-tab-content active">
            <div style="display:flex; flex-wrap:wrap; gap:16px;">
                ...
                <div style="flex:1; min-width:260px; background:#f8fafc; border-radius:10px; border:1px solid #e2e8f0; padding:14px;">
                    <h3 style="font-size:13px; font-weight:bold; color:#1e3a8a; margin:0 0 10px 0; border-bottom:2px solid #bfdbfe; padding-bottom:5px; text-transform:uppercase; font-family:Arial,Helvetica,sans-serif;"><i class="fas fa-user-circle" style="margin-right:5px;"></i> Thông tin cá nhân</h3>
                    <table width="100%" cellpadding="3" cellspacing="0" style="font-size:13px; color:#374151; text-align:left; font-family:Arial,Helvetica,sans-serif;">
                        <tr><td width="90" style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Họ tên:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0; text-transform:uppercase;">{{HoTen}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Ngày sinh:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{NgaySinh}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">CCCD:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{CCCD}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">SBD:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{SBD}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Giới tính:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{GioiTinh}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">SĐT:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{SDT}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Email:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{Email}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">KV ƯT:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{KhuVuc}}</td></tr>
                        <tr><td style="color:#6b7280; white-space:nowrap;">ĐT ƯT:</td><td style="font-weight:bold; color:#111827;">{{DoiTuong}}</td></tr>
                    </table>
                </div>
                <!-- Cột phải: Thông tin xét tuyển -->
                <div style="flex:1; min-width:260px; background:#f8fafc; border-radius:10px; border:1px solid #e2e8f0; padding:14px;">
                    <h3 style="font-size:13px; font-weight:bold; color:#b91c1c; margin:0 0 10px 0; border-bottom:2px solid #fecaca; padding-bottom:5px; text-transform:uppercase; font-family:Arial,Helvetica,sans-serif;"><i class="fas fa-graduation-cap" style="margin-right:5px;"></i> Thông tin xét tuyển</h3>
                    <table width="100%" cellpadding="3" cellspacing="0" style="font-size:13px; color:#374151; text-align:left; font-family:Arial,Helvetica,sans-serif;">
                        <tr><td width="90" style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Ngành TT:</td><td style="font-weight:bold; color:#b91c1c; border-bottom:1px dashed #e2e8f0; text-transform:uppercase;">{{Nganh}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Mã ngành:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{MaNganh}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">P. thức:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{PhuongThuc}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Tổ hợp:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{ToHop}}</td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Điểm môn:</td><td style="color:#111827; border-bottom:1px dashed #e2e8f0;"><b>{{DM1}}</b> | <b>{{DM2}}</b> | <b>{{DM3}}</b></td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">ƯT / QĐ:</td><td style="color:#111827; border-bottom:1px dashed #e2e8f0;"><b>{{DiemUT}}</b> / <b>{{UTQ}}</b></td></tr>
                        <tr><td style="color:#6b7280; border-bottom:1px dashed #e2e8f0; white-space:nowrap;">Tổ hợp:</td><td style="font-weight:bold; color:#111827; border-bottom:1px dashed #e2e8f0;">{{DiemToHop}}</td></tr>
                        <tr><td style="font-weight:bold; color:#b91c1c; white-space:nowrap;">ĐXT:</td><td style="font-weight:bold; color:#b91c1c;">{{DiemXT}}</td></tr>
                    </table>
                </div>
            </div>
            {{NutXemGiayBao}}
